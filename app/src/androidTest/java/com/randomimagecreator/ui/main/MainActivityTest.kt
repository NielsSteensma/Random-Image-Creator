...
class MainActivityTests {
    ...
    fun imageCreation_GivenValidImageCreationOptions_CreatesImages() {
        ...
        onView(withId(R.id.image_creator_option_amount)).perform(
            typeText(amount.toString()),
            closeSoftKeyboard()
        )
        onView(withId(R.id.image_creator_option_width)).perform(
            typeText(width.toString()),
            closeSoftKeyboard()
        )
        onView(withId(R.id.image_creator_option_height)).perform(
            typeText(height.toString()),
            closeSoftKeyboard()
        )
